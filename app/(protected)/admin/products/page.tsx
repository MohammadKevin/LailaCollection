                    ...
                    <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm h-fit">
                        ...
                        <div className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full bg-gradient-to-r from-pink-600 to-rose-600 hover:opacity-90 disabled:opacity-50 transition-all text-white py-3 rounded-2xl font-bold flex items-center justify-center gap-2"
                            >
                                {submitting ? (
                                    <>
                                            ...
                                            <div className="p-5">
                                                ...
                                                <div className="grid grid-cols-2 gap-3 mt-5">
                                                    <button
                                                        ...
                                                        className="bg-blue-50 hover:bg-blue-100 text-blue-600 py-3 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 transition-all"
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        className="bg-red-50 hover:bg-red-100 text-red-600 py-3 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 transition-all"
                                                    >
